...
export default function DossierCompiler({ initialCandidate }) {
  ...
  useEffect(() => {
    if (initialCandidate?.name) {
      setCandidateName(initialCandidate.name);
    }
    if (initialCandidate?.notes) {
      setRecruiterNotes(initialCandidate.notes);
    }
  }, [initialCandidate]);
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                className="form-input"
                placeholder="e.g. Cleared technical screen. Excellent communication."
          ...
          >
            {isCompiling ? (
              <>
                ...
                <span>Compiling Word Dossier...</span>
              </>
            ) : (
              <>
                <IconBolt size={18} />
                <span>Compile & Generate Verified Dossier (.DOCX)</span>
              </>
            )}
          </button>
        </form>
